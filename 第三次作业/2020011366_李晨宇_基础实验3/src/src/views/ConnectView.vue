  ...
  <div id="outter">
    <div id="main-block">
      ...
      <div id="info">
        ...
        <router-link to="/info" target="_blank" id="getinfo" >
          <div>查看流量使用情况</div>
        </router-link>
    </div>
  </div>
...
export default
{
  ...
  created(){
    let d = new Date()
    let start = d.getFullYear() + '-' + (d.getMonth()+1) + '-' + d.getDate() + ' ' + d.getHours() + ':' + d.getMinutes() + ':' + d.getSeconds()
